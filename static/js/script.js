document.addEventListener('DOMContentLoaded', () => {
    ...
    const carregarImagemAtiva = (categoria) => {
        ...
        if (categoria === 'olhos' || categoria === 'sobrancelhas') {
            ...
            config.imgEsquerda = criarImagem(`${categoria}-esquerda`, `/static/img/${config.prefixo}${novoIndice}.png`);
            config.imgDireita = criarImagem(`${categoria}-direita`, `/static/img/${config.prefixo}${novoIndice}.png`);
            ...
            const img = criarImagem(`${categoria}-option`, `/static/img/${config.prefixo}${novoIndice}.png`);
