document.addEventListener('DOMContentLoaded', () => {
    ...
    const carregarImagemAtiva = (categoria) => {
        ...
        if (categoria === 'olhos' || categoria === 'sobrancelhas') {
            ...
            config.imgEsquerda = criarImagem(`${categoria}-esquerda`, `/docs/${config.prefixo}${novoIndice}.png`);
            config.imgDireita = criarImagem(`${categoria}-direita`, `/docs/${config.prefixo}${novoIndice}.png`);
            ...
            const img = criarImagem(`${categoria}-option`, `/docs/${config.prefixo}${novoIndice}.png`);
